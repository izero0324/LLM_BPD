...
pipe = pipeline("text-generation", model="codellama/CodeLlama-7b-Instruct-hf", max_length = 512)
...
def codellamains(code, model_name = 'codellama'):
    # Define a prompt to simulate the role of the system
    system_prompt =  "You are a expert Python programmer, and here is your task:\n \
